...
{
    public sealed class ScreenStrecher : IDisposable
    {
        ...
        public ScreenStrecher(Game game, int width, int height) 
        {
            width = (int)Util.Clamp(width, ScreenStrecher.MinDim, ScreenStrecher.MaxDim);
            height = (int)Util.Clamp(height, ScreenStrecher.MinDim, ScreenStrecher.MaxDim);
