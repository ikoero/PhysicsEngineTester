...
namespace FlatPhysics
{
    public static class Collisions
    {
        public static void PointSegmentDistance(FlatVector p, FlatVector a, FlatVector b, out float distanceSquared, out FlatVector cp)
        {
            ...
            float abLenSq = FlatMath.LengthSquarred(ab);
            ...
            distanceSquared = FlatMath.DistanceSquarred(p, cp);
        }
        ...
        public static void FindPolygonsContactPoints(FlatVector[] verticesA, FlatVector[] verticesB, out FlatVector contact1,
            out FlatVector contact2, out int contactCount)
        {
            contact1 = FlatVector.Zero;
            contact2 = FlatVector.Zero;
            contactCount = 0;
